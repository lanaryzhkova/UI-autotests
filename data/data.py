...
expected_navigation_links = ["All Courses"]

expected_submenu_links = ["Lifetime Membership"]

valid_user = {"username": "angular", "password": "password", "description": "test user"}
...
customer = {"first_name": "Test", "last_name": "Customer", "postcode": "12345"}
